...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-ordpens-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12386&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ordpens-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ordpens` can be installed with:

```
conda install r-ordpens
```

It is possible to list all of the versions of `r-ordpens` available on your platform with:
